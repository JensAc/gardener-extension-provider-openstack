...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenStackNetworkPort) DeepCopyInto(out *OpenStackNetworkPort) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenStackNetworkPort.
func (in *OpenStackNetworkPort) DeepCopy() *OpenStackNetworkPort {
	if in == nil {
		return nil
	}
	out := new(OpenStackNetworkPort)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkerConfig) DeepCopyInto(out *WorkerConfig) {
	*out = *in
	...
	if in.AdditionalNetworkPorts != nil {
		in, out := &in.AdditionalNetworkPorts, &out.AdditionalNetworkPorts
		*out = make([]OpenStackNetworkPort, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
