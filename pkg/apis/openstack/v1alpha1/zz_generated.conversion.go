...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*OpenStackNetworkPort)(nil), (*openstack.OpenStackNetworkPort)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_OpenStackNetworkPort_To_openstack_OpenStackNetworkPort(a.(*OpenStackNetworkPort), b.(*openstack.OpenStackNetworkPort), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*openstack.OpenStackNetworkPort)(nil), (*OpenStackNetworkPort)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_openstack_OpenStackNetworkPort_To_v1alpha1_OpenStackNetworkPort(a.(*openstack.OpenStackNetworkPort), b.(*OpenStackNetworkPort), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_OpenStackNetworkPort_To_openstack_OpenStackNetworkPort is an autogenerated conversion function.
func Convert_v1alpha1_OpenStackNetworkPort_To_openstack_OpenStackNetworkPort(in *OpenStackNetworkPort, out *openstack.OpenStackNetworkPort, s conversion.Scope) error {
	return autoConvert_v1alpha1_OpenStackNetworkPort_To_openstack_OpenStackNetworkPort(in, out, s)
}
...
// Convert_openstack_OpenStackNetworkPort_To_v1alpha1_OpenStackNetworkPort is an autogenerated conversion function.
func Convert_openstack_OpenStackNetworkPort_To_v1alpha1_OpenStackNetworkPort(in *openstack.OpenStackNetworkPort, out *OpenStackNetworkPort, s conversion.Scope) error {
	return autoConvert_openstack_OpenStackNetworkPort_To_v1alpha1_OpenStackNetworkPort(in, out, s)
}
...
func autoConvert_v1alpha1_WorkerConfig_To_openstack_WorkerConfig(in *WorkerConfig, out *openstack.WorkerConfig, s conversion.Scope) error {
	...
	out.AdditionalNetworkPorts = *(*[]openstack.OpenStackNetworkPort)(unsafe.Pointer(&in.AdditionalNetworkPorts))
...
func autoConvert_openstack_WorkerConfig_To_v1alpha1_WorkerConfig(in *openstack.WorkerConfig, out *WorkerConfig, s conversion.Scope) error {
	...
	out.AdditionalNetworkPorts = *(*[]OpenStackNetworkPort)(unsafe.Pointer(&in.AdditionalNetworkPorts))
